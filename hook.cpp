...
class EntityAimFix {
	std::map<std::string, FVector> fix; //根据生物名称进行修正坐标
...
public:
	EntityWhiteList() {
		aimWhiteList.insert("ENE_Spider_ShieldTank"); //大蜘蛛
		aimWhiteList.insert("ENE_Spider_Tank_Boss"); //大蜘蛛
		aimWhiteList.insert("ENE_Spider_Tank_Normal"); //禁卫
		aimWhiteList.insert("ENE_Spider_Boss"); //大蜘蛛
		aimWhiteList.insert("ENE_Spider_Grunt_Rock"); //石头人
		aimWhiteList.insert("BP_FriendlyShredder"); //友方
		aimWhiteList.insert("ENE_InfectedMule"); //感染的莫里
