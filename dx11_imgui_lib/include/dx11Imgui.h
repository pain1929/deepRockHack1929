...
#ifdef DX11_IMGUI_BUILDING
#define DX11_IMGUI_API __declspec(dllexport)
#else
#define DX11_IMGUI_API __declspec(dllimport)
#endif


using dx11_imgui_init = void (*)();
...
class DX11_IMGUI_API Dx11Imgui {

public:
    /*初始化*/
    static bool init(dx11_imgui_init init_call);
    /*添加窗口渲染*/
    static void addRender(IRender* render);
   
    /*获取屏幕宽度*/
    static int getWindowWidth();
    /*获取屏幕高度*/
    static int getWindowHight();
